...
import top.hzfq.flowable.service.FlowableRepositoryService;
 ...
 */
@Service
public class FlowableBpmnModelServiceImpl implements FlowableModelService {
    ...
    private BpmnModel parseBpmnModel(InputStream modelIS) {
        try {
            return bpmnXMLConverter
                    .convertToBpmnModel(XmlUtil.createSafeXmlInputFactory()
                            .createXMLStreamReader(modelIS, StandardCharsets.UTF_8.name()));
